...
class SettingsWindow(ctk.CTk):
    def __init__(self, config_path):
        ...
        self.lbl_folder = ctk.CTkLabel(self.folder_frame, text="Watch Folder:")
        ...
        self.chk_gamer = ctk.CTkCheckBox(self, text="Enable Gamer Mode", variable=self.gamer_mode_var)
        ...
        self.lbl_cpu.grid(row=4, column=0, padx=20, pady=(10, 0), sticky="w")
        
        self.slider_cpu = ctk.CTkSlider(self, from_=50, to=100, command=self.update_cpu_label)
        self.slider_cpu.grid(row=5, column=0, padx=20, pady=10, sticky="ew")

        # Save Button
        self.btn_save = ctk.CTkButton(self, text="Save & Close", command=self.save_settings)
        self.btn_save.grid(row=8, column=0, padx=20, pady=20)
